        ...
        <div className="flex items-start justify-between">
          <div className="flex-1">
            ...
            <p className="text-gray-600 mb-4">
              Você tem {limitedProposalsRemaining} propostas restantes e {daysRemaining} dias do seu período gratuito. O que acabar primeiro determina o fim do período gratuito.
            </p>
